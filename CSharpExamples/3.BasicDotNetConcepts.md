.NET Framework
==============
It is a complete framwork or environment that allows developers to create, build, run and deploy .NET based applications like.
Windows, web, service, console, web service, window services, wpf, wcf & WWF.
It allows multiple high level programming langulages like VC++, VB, VC#, F#.
It supports Object Oriented Programming Model.
...
Common Type System
Application Support[Windows, Web, Services]
